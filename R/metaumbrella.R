...
#' Seven types of effect size measures are accepted:
#' \itemize{
...
#'  }
#' \item \bold{r}: The value of the correlation coefficient between the outcomes/time-points of a study.
